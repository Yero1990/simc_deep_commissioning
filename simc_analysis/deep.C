...
//by  b_branchname->GetEntry(ientry); //read only this branch
 ...
 // define histograms
   ...
   TH1F *Emiss = new TH1F("Emiss","missing energy", bins, -0.08, 0.5);  //binwidth = 0.0025
   TH1F *pm = new TH1F("pm","missing momentum", bins, 0.0, 2.5);
   ...
   TH1F *theta_elec = new TH1F("theta_elec", "Electron Scatt. Angle", 100, 8., 15.);
   TH1F *theta_prot = new TH1F("theta_prot", "Proton Scatt. Angle", 100, 35., 65.);
   ...
   TH2F *pm_vs_thnq = new TH2F("pm_vs_thnq", "", bins, 0., 80., bins, 0., 2.5);
   ...
   /************Define Histos to APPLY CUTS*********************************/
     ...
     //Kinematics Quantities
   TH1F *cut_Emiss = new TH1F("cut_Emiss","missing energy", bins, -0.08, 0.5);  //binwidth = 0.0025
   TH1F *cut_pm = new TH1F("cut_pm","missing momentum", bins, 0.0, 2.5);
