...
void comparePWIA_deep_norm(int set, int pm, string model, string rad)
{
 ...
 //change to simc_file
  ...
  simcPWIA_file->GetObject("Emiss", simc_emiss_pwia);
  ...
  simcPWIA_file->GetObject("Mmiss", simc_MM_pwia);
  ...
  //Overlay SIMC/data plots (*** VERY IMPORTANT ***: Range and #bins must be same)
   ...
   simc_eytar_pwia->DrawNormalized("sames");
   ...
   simc_exptar_pwia->DrawNormalized("sames");
   ...
   simc_eyptar_pwia->DrawNormalized("sames");
   ...
   simc_edelta_pwia->DrawNormalized("sames");
  ...
  //Set Legend
   ...
   simc_exfp_pwia->DrawNormalized("sames");
   ...
   simc_eyfp_pwia->DrawNormalized("sames");
   ...
   simc_expfp_pwia->DrawNormalized("sames");
   ...
   simc_eypfp_pwia->DrawNormalized("sames");
   ...
   simc_emiss_pwia->DrawNormalized("sameshist");
   ...
   simc_MM_pwia->DrawNormalized("sames");
   ...
   simc_Pmx_pwia->DrawNormalized("sames");
   ...
   simc_Pmy_pwia->DrawNormalized("sames");
   ...
   simc_Pmz_pwia->DrawNormalized("sames");
   ...
   simc_Q2_pwia->DrawNormalized("sames");
   simc_Q2_pwia->DrawNormalized("SAMES");
   ...
   simc_omega_pwia->DrawNormalized("sames");
   ...
   simc_xbj_pwia->DrawNormalized("sames");
   ...
   simc_W2_pwia->DrawNormalized("sames");
   ...
   simc_th_elec_pwia->DrawNormalized("sames");
   ...
   simc_kf_pwia->DrawNormalized("sames");
   ...
   simc_thq_pwia->DrawNormalized("sames");
   ...
   simc_q_pwia->DrawNormalized("sames");
   ...
   simc_Pf_pwia->DrawNormalized("sames");
   ...
   simc_th_prot_pwia->DrawNormalized("sames");
   ...
   simc_Kp_pwia->DrawNormalized("sames");
   ...
   simc_Ep_pwia->DrawNormalized("sames");
   ...
   simc_Kn_pwia->DrawNormalized("sames");
   ...
   simc_En_pwia->DrawNormalized("sames");
   ...
   simc_thpq_pwia->DrawNormalized("sames");
   ...
   simc_thnq_pwia->DrawNormalized("sames");
